 ...
 */
// TODO-04: Refactor so it uses Spring's JdbcTemplate and a RowMapper called RestaurantRowMapper. After making the changes, 
// execute the JdbcRestaurantRepositoryTests class to ensure that the existing implementation functions correctly.
