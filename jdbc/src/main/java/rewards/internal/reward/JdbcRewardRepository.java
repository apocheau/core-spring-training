...
// TODO-03: Add a field of type JdbcTemplate and refactor the constructor, nextConfirmationNumber() and confirmReward(...)
// After making the changes, execute the test class (JdbcRewardRepositoryTests) to verify its successful execution.
