 ...
 */
// TODO 01: add 2 configuration files: test-infrastructure-config.xml and application-config.xml
// You can then run the current test and make sure you have the green bar
