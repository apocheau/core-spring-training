...
public class RewardNetworkImpl implements RewardNetwork {
	...
	/* TODO-04: Add non-default propagation level (don't do this until instructed).
				After making the changes for this task, run the RewardNetworkPropagationTests 
				class. Change the propagation level back, after running the test. */
